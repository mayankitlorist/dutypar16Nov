...
class AttendencedetailController extends Controller
{
    ...
    if($user->id == 55034){
         ...
         $batch = UserAttendance::staticuserbatchold($data);

    }else{

       $batch = UserAttendance::loginuserbatchold($user->id);

    }

    
      $users = UserAttendance::getalldataattendencenewfilterold($_POST['batch'],$_POST['date'],$_POST['date1']);
